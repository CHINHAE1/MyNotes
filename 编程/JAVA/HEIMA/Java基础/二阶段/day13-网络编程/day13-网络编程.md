...
![](attachments/day13-网络编程_image_3.png)
...
![](attachments/day13-网络编程_image_4.png)
...
![](attachments/day13-网络编程_image_5.png)

如果想查看本机的IP地址，可以在命令行窗口，输入`ipconfig`命令查看，如下图所示

![](attachments/day13-网络编程_image_6.png)
...
![](attachments/day13-网络编程_image_7.png)

我们在命令行窗口输入`ipconfig`命令，同样可以看到ipv6地址，如下图所示

![](attachments/day13-网络编程_image_8.png)
...
![](attachments/day13-网络编程_image_9.png)
...
![](attachments/day13-网络编程_image_10.png)
...
![](attachments/day13-网络编程_image_11.png)
...
![](attachments/day13-网络编程_image_12.png)
...
![](attachments/day13-网络编程_image_13.png)

为了让世界上各种上网设备能够互联互通，肯定需要有一个组织出来，指定一个规则，大家都遵守这个规则，才能进行数据通信。

![](attachments/day13-网络编程_image_14.png)

只要按照OSI网络参考模型制造的设备，就可以在国际互联网上互联互通。其中传输层有两个协议，是我们今天会接触到的（UDP协议、TCP协议）

- **UDP协议特点**

![](attachments/day13-网络编程_image_15.png)

- **TPC协议特点**

![](attachments/day13-网络编程_image_16.png)

三次握手如下图所示**：目的是确认通信双方，手法消息都是正常没问题的**

![](attachments/day13-网络编程_image_17.png)

四次挥手如下图所示：**目的是确保双方数据的收发已经完成，没有数据丢失**

![](attachments/day13-网络编程_image_18.png)
...
![](attachments/day13-网络编程_image_19.png)
...
![](attachments/day13-网络编程_image_20.png)
...
![](attachments/day13-网络编程_image_21.png)
...
![](attachments/day13-网络编程_image_22.png)
...
![](attachments/day13-网络编程_image_23.png)
...
![](attachments/day13-网络编程_image_24.png)
