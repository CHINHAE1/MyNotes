...
![](attachments/day10-IO流（二）_image_1.png)
...
![](attachments/day10-IO流（二）_image_2.png)

需要用到的方法：先通过构造器创建对象，再通过read方法读取数据（**注意：两个read方法的返回值，含义不一样**）

![](attachments/day10-IO流（二）_image_3.png)
...
![](attachments/day10-IO流（二）_image_4.png)
...
![](attachments/day10-IO流（二）_image_5.png)
...
![](attachments/day10-IO流（二）_image_6.png)
...
![](attachments/day10-IO流（二）_image_7.png)
...
![](attachments/day10-IO流（二）_image_18.png)
...
![](attachments/day10-IO流（二）_image_19.png)
...
![](attachments/day10-IO流（二）_image_20.png)
...
![](attachments/day10-IO流（二）_image_21.png)
...
![](attachments/day10-IO流（二）_image_22.png)
...
![](attachments/day10-IO流（二）_image_23.png)
...
![](attachments/day10-IO流（二）_image_24.png)
...
![](attachments/day10-IO流（二）_image_25.png)
