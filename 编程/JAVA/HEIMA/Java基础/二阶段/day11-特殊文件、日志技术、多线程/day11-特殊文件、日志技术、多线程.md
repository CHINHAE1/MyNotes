...
![](attachments/day11-特殊文件、日志技术、多线程_image_3.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_4.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_5.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_6.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_7.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_8.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_9.png)

**接下，同学们可以跟着步骤新建一个XML文件，试试！**

![](attachments/day11-特殊文件、日志技术、多线程_image_10.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_11.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_12.png)

由于DOM4J是第三方提供的，所以需要把第三方提供的Jar包导入到自己的项目中来，才可以使用。具体步骤如下：

![](attachments/day11-特殊文件、日志技术、多线程_image_13.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_14.png)

DOM4J解析XML需要用到的方法如下图所示

![](attachments/day11-特殊文件、日志技术、多线程_image_15.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_16.png) 

### 2.3 XML解析2

获取到XML文件的根元素之后，接下来，就可以用根元素在获取到它里面的子元素（包括子标签、表属性等）。需要用到的方法如下图所示

![](attachments/day11-特殊文件、日志技术、多线程_image_17.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_18.png)
...
- DTD约束案例
  ...
  ![](attachments/day11-特殊文件、日志技术、多线程_image_19.png)
...
- Schame约束案例
  ...
  ![](attachments/day11-特殊文件、日志技术、多线程_image_20.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_21.png)

**这里推荐同学们使用Logback日志框架，也在行业中最为广泛使用的。**

**Logback日志分为哪几个模块**

![](attachments/day11-特殊文件、日志技术、多线程_image_22.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_23.png)

同时在文件中，也有一份这样的日志信息。文件在哪里内，从配置文件中去找

![](attachments/day11-特殊文件、日志技术、多线程_image_24.png)

打开`D:/log/itheima-data.log`看一下文件中是否有记录日志吧！！

![](attachments/day11-特殊文件、日志技术、多线程_image_25.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_26.png)

- **如下图所示，控制打开和关闭日志**

![](attachments/day11-特殊文件、日志技术、多线程_image_27.png)

- **如下图所示，控制日志的输出的格式**

  日志格式是由一些特殊的符号组成，可以根据需要删减不想看到的部分。比如不想看到线程名那就不要[%thread]。但是不建议同学们更改这些格式，因为这些都是日志很基本的信息。

![](attachments/day11-特殊文件、日志技术、多线程_image_28.png)

### 3.5 配置日志级别

![](attachments/day11-特殊文件、日志技术、多线程_image_29.png)

- 在哪里配置日志级别呢？如下图所示

![](attachments/day11-特殊文件、日志技术、多线程_image_30.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_31.png)
...
![](attachments/day11-特殊文件、日志技术、多线程_image_32.png)
